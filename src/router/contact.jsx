...
<Box color={'#007f7f'} w='30%' >
    <Text>Addtess : AT-MIDNAPORE STATION ROAD,NEAR WATER TANK,PASCHIM MEDINIPUR,WEST BENGAL,PIN-721101</Text><br />
...
<form action="https://formspree.io/f/mqkjajnd"
  method="POST" >
    <Input value={'JOB-SEEKER'+"  "+NAME}  readOnly  name='subject' required autoComplete="off"  placeholder="enter subject" />
    <Input onChange={(e)=>setName(e.target.value)} type="text" name='name' required autoComplete="off"  placeholder="enter your name" />
    <Input type="email" name='email'  required autoComplete="off" placeholder="enter your email"/>
    <Input  type="number" name='Number'  required autoComplete="off" placeholder="enter your Contact Number"/>
    <Input  type="text" name='message'  autoComplete="off"  placeholder="enter your message" />
    <Input  type='submit' color={'white'} _hover={{backgroundColor:'green'}}  bg='#007f7f' />
    </form>
</Stack>
</Flex>
